...
export function GetAllGdriveCache():Promise<Array<database.CacheKeyValue>>;

export function GetAllKemonoCreatorCache():Promise<Array<database.KeyValue>>;

export function GetAllUgoiraCache():Promise<Array<database.CacheKeyValue>>;
