...
export function CancelGDriveOauth() {
  return window['go']['app']['App']['CancelGDriveOauth']();
}
...
export function GetGDriveClientAndOauthToken() {
  return window['go']['app']['App']['GetGDriveClientAndOauthToken']();
}
...
export function StartGDriveOauth() {
  return window['go']['app']['App']['StartGDriveOauth']();
}
...
export function UnsetGDriveJson() {
  return window['go']['app']['App']['UnsetGDriveJson']();
}
...
export function ValidateGDriveOauth() {
  return window['go']['app']['App']['ValidateGDriveOauth']();
}
